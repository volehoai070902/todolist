...
import 'package:todo_list/views/components/loading/loading_screen_controller.dart';
import 'package:todo_list/views/constants/strings.dart';
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      StreamBuilder(
                        stream: textController.stream, builder: (context, snapshot){
                          if(snapshot.hasData){
